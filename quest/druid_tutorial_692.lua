...
Description[GERMAN][7] =  "Blicke in den Kessel der Seherin vor Fianna, um deine Reise in die Naturmagie und ihre Verflechtungen fortzusetzen."
Description[ENGLISH][7] =  "Look into the seer's cauldron in front of Fianna to continue on your journey into nature magic and its weaves."
Description[GERMAN][8] =  "Sprich mit Fianna in Trollhafen, um fortzufahren."
Description[ENGLISH][8] =  "Talk to Fianna in Troll's Haven to continue."
Description[GERMAN][9] =  "Besorge dir einen Weberbeutel. Ein Schneider kann ihn herstellen, oder du kannst ihn von Fianna kaufen. Halte ihn dann in den Händen und doppelklicke auf ein nicht leeres Siegel, um ihn aufzuladen."
Description[ENGLISH][9] =  "Obtain a weaver's pouch. A tailor can make them, or you can buy it from Fianna. Then hold it in your hands and double click a non-empty sigil to charge it."
Description[GERMAN][10] =  "Sprich mit Fianna in Trollhafen, um fortzufahren."
Description[ENGLISH][10] =  "Talk to Fianna in Troll's Haven to continue."
Description[GERMAN][11] =  "Mit dem Weberbeutel an deinem Gürtel und einem Cor-Stab in deinen Händen kannst du nun deinen ersten Zauber wirken. Du kannst dies tun, indem du ihn laut aussprichst (Groß- und Kleinschreibung beachten), auf deinen Cor-Stab doppelklickst oder deinen Cor-Stab auf einen bestimmten Zauber einstimmst und dann doppelklickst."
Description[ENGLISH][11] =  "With the weaver's pouch on your belt and a cor staff in your hands, you can now cast your first spell. You can do so by speaking it aloud (case-sensitive), double click your cor-staff or attuning your cor-staff to a specific spell then double clicking it."
Description[GERMAN][12] =  "Sprich mit Fianna in Trollhafen, um fortzufahren."
Description[ENGLISH][12] =  "Talk to Fianna in Troll's Haven to continue."
Description[GERMAN][13] =  "Du hast das Tutorial über Naturmagie und ihre Verflechtungen abgeschlossen. Du kannst Fianna jederzeit nach dem Tutorial über Alchemie oder Transmutation fragen oder den Kessel der Seherin in Trollhafen aufsuchen, um weitere Zauber zu erlernen. In diesem Tutorial hast du etwas über die Verflechtungen, Meditation, Siegel sowie die Verwendung von Siegeln, Weberbeuteln und einem Cor-Stab gelernt, um Zauber zu wirken, die du über den Kessel der Seherin erlernst."
Description[ENGLISH][13] =  "You've completed the tutorial on nature magic and its weaves. You can always ask Fianna about the tutorial on Alchemy or Transmutation, or seek out the Seer's Cauldron in Troll's Haven to learn more spells. In this tutorial you learned about the weaves, meditation, sigils and how to use sigils, weavers pouches and a cor staff to cast spells you learn via the Seer's Cauldron."
